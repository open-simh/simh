...
if (WITH_NETWORK)
    ...
    if (VDE_FOUND)
        if (TARGET PkgConfig::VDE)
            target_compile_definitions(simh_video INTERFACE $<TARGET_PROPERTY:PkgConfig::VDE,INTERFACE_COMPILE_DEFINITIONS>)
            target_include_directories(simh_video INTERFACE $<TARGET_PROPERTY:PkgConfig::VDE,INTERFACE_INCLUDE_DIRECTORIES>)
            target_link_libraries(simh_video INTERFACE PkgConfig::VDE)
