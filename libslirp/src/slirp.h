...
#if !defined(HAVE__LSEEK)
#define slirp_os_lseek lseek
#else
#define slirp_os_lseek _lseek
#endif

#if !defined(HAVE__READ)
#define slirp_os_read read
#else
#define slirp_os_read _read
#endif

#if !defined(HAVE__CLOSE)
#define slirp_os_close close
#else
#define slirp_os_close _close
#endif

#if !defined(HAVE_SSCANF_S)
#define slirp_sscanf sscanf
#define sscanf_buf_arg(buf) buf
#else
#define slirp_sscanf sscanf_s
#define sscanf_buf_arg(buf) buf, (int) sizeof(buf)
#endif
